...
function canvasApp() {
    ...
    helpBtn.addEventListener('click',function(){
        universalDialog('How to play this game');
    });
    settingsBtn.addEventListener('click',function(){
        universalDialog('Setting will be Display Here');
    });
    accountBtn.addEventListener('click',function(){
        universalDialog('User Status');
    });
    ...
    function level0() {
        level(0, 'pikachu', 10, 12);
    }
    function level1() {
        level(1, 'rattata', 10, 12);
    }
    function level2() {
        level(2, 'snorlax', 10, 12);

    }
    function level3() {
        level(3, 'pikachu', 10, 12);

    }

    function level4() {
        level(4, 'rattata', 10, 12);

    }
    function level5() {
        level(5, 'snorlax', 10, 12);
    }
    function level6() {
        level(6, 'rattata', 10, 12);

    }
    function level7() {
        level(7, 'pikachu', 10, 12);

    }
    function level8() {
        level(8, 'snorlax', 10, 10);

    }
    function level9() {
        level(9, 'pikachu', 10, 10);
